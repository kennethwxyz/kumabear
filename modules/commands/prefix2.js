module.exports.config = {
	...
	version: "7.6.8",
	hasPermssion: 1,
	credits: "Jasper wu",//bawal palitan kung tanga ka at bobo palitan mona**
	description: "Rank up ni jasper",
	commandCategory: "IMG",
	dependencies: {
		"fs-extra": ""
	},
...
module.exports.handleEvent = async function({ api, event, Currencies, Users, getText }) {
  ...
  fs.writeFileSync(pathImg, Buffer.from(getbackground, "utf-8"));
    ...
    ctx.drawImage(baseAvt1, 35, 120, 140, 130);
...
module.exports.languages = {
	...
	"en": {
		...
		"levelup": "━━━━━━━━━━━━━━━━━\nLEVELUP!! +{level} TIGANG POINTS\n{name} grabe ka idol HAHA,\n━━━━━━━━━━━━━━━━━",
	}
}
