...
monitor.on('up', (res) => console.log(chalk.bold.hex("#00FF00")("[ Excikel ] ❯ ") + chalk.hex("#00FF00")(`${res.website}`)))
...
function startBot(message) {
    ...
    const child = spawn("node", ["--trace-warnings", "--async-stack-traces", "Excikel.js"], {
        cwd: __dirname,
        stdio: "inherit",
        shell: true
    });
...
app.get('/', (req, res) => res.sendFile(__dirname+'/Excikel.html'))